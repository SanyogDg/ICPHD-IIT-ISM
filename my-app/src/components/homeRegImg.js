    ...
    return(
        <div className="bgImg w-[100vw] h-[100vh]   flex flex-row justify-center items-center">
          ...
          <div className="w-[50vw] flex flex-col items-center opacity-100">
             ...
             <div className="text-[2rem] font-bold text-[#00187B] text-center opacity-100"> Fueling Your Journey with Quality Petroleum Solutions
             </div>

             <div className="text-[1.5rem] font-semibold text-brown-500 text-center text-[#00187B]">  
