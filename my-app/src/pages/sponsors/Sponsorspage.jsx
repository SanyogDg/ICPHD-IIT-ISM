...
export const Sponsorspage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center mt-8">
      ...
      <div className="w-full flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-8 lg:space-x-16 mt-8 gap-[5rem]" >
        ...
        <div className="flex flex-col items-center">
          <img src='./sunpetro.png' className="w-32 md:w-40 lg:w-48 p-2" alt="Sun Petrochemicals" />
